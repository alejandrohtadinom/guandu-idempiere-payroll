...
public class CustomMHRPaymentSelection extends MHRPaymentSelection{
	 ...
	 *
	 */
	public CustomMHRPaymentSelection(Properties ctx, int HR_PaymentSelection_ID, String trxName) {
	 ...
	 *
	 */
	public CustomMHRPaymentSelection(Properties ctx, ResultSet rs, String trxName) {
